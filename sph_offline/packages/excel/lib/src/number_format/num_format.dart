...
class NumFormatMaintainer {
  ...
  void add(int numFmtId, CustomNumFormat format) {
    if (numFmtId >= _firstCustomFmtId && _map.containsKey(numFmtId)) {
...
sealed class NumFormat {
  ...
  static const standard_41 = StandardNumericNumFormat._(
      numFmtId: 41, formatCode: '_(* #,##0_);_(* (#,##0);_(* "-"_);_(@_)');
  ...
  static const standard_43 = StandardNumericNumFormat._(
      numFmtId: 43, formatCode: '_(* #,##0.00_);_(* (#,##0.00);_(* "-"??_);_(@_)');
  static const standard_44 = StandardNumericNumFormat._(
      numFmtId: 44, formatCode: r'_("$"* #,##0.00_);_("$"* (#,##0);_("$"* "-"??_);_(@_)');
