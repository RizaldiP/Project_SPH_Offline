      ...
      actions: [
        ...
        FilledButton(
          onPressed: () {
            ...
            final material = int.tryParse(_materialController.text.replaceAll('.', '')) ?? 0;
            final jasa = int.tryParse(_jasaController.text.replaceAll('.', '')) ?? 0;
            final unitPrice = int.tryParse(_unitPriceController.text.replaceAll('.', '')) ?? 0;
            final total = int.tryParse(_totalController.text.replaceAll('.', '')) ?? 0;
            ...
            final updated = widget.item.copyWith(
              ...
              totalPrice: total > 0 ? total : (qty * (_manualMode ? unitPrice : (material + jasa))).round(),
            );
